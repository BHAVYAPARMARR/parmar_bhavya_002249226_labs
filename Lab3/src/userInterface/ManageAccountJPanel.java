...
public class ManageAccountJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSearch.setText("Search by Account No. :");
        ...
        btnDeleteAccount.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
    ...
    private void btnViewDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDetailsActionPerformed
        // TODO add your handling code here:
            int selectedRow = tblAccounts.getSelectedRow();
            if(selectedRow<0){
                JOptionPane.showMessageDialog(null,"Select a row from the table to view the details!","Warning", JOptionPane.WARNING_MESSAGE);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(result==null){
              JOptionPane.showMessageDialog(null,"Account number entered does not exist!",
